...
// --- (ĐÃ SỬA: Bảng giá động) ---
const VehiclePriceTable = () => {
    // State để lưu giá tải về
...
    // Tải bảng giá từ API (công khai, không cần auth)
    useEffect(() => {
        const fetchPrices = async () => {
            try {
                // SỬ DỤNG API ROUTE MỚI
...
    if (loading) {
        return (
            <Card className="mb-4 price-table-card text-center p-4">
...
                    _                                 <Card.Text className="text-muted">(Slots left: {2 - vehicleCounts.motorbike})</Card.Text>
                                                </Card.Body>
                                            </Card>
                                        </Col>
                                    ) : (
